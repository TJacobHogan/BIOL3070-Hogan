...
Fig 1 and 2 This formats our data so R can effectively read and format
the state’s data First, we define our pattern and format the COPD data
...
data and create the color scale We then map the data
...
![](COPD_Markdown_JacobHogan_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
![](COPD_Markdown_JacobHogan_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->

# air quality index

Fig 4. This code chunk creates the overall AQI map. We begin by
reformatting the raw data. Second we join the reformatted data to the
mapping package. Lastly we print the map
...
![](COPD_Markdown_JacobHogan_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
Lastly, we normalize our data using the SQRT method. Normalization is
required in this instance because our data does not follow a normal
distribution. We chose the SQRT method because our data was
right-skewed, a normalcy test was not required in this instance because
...
![](COPD_Markdown_JacobHogan_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](COPD_Markdown_JacobHogan_files/figure-gfm/unnamed-chunk-10-2.png)<!-- -->
